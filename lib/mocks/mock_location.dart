...
class MockLocations extends Location {
  static final List<Location> items = [
    ...
    Location(
      name: 'Bianca',
      url: 'https://dogtime.com/assets/uploads/2018/10/puppies-cover-1280x720.jpg',
      facts: <LocationFact>[
        LocationFact(
          title: 'Summary',
          text: 'Hello. My name is Bianca. I have 3 years of experience as a nanny. I would love to help you and your family.'),
        LocationFact(
